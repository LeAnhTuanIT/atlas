...
export interface IEntitlementCacheService {
  getFeatureExpiration(shopId: string, featureCode: string): Promise<number | null>;
  setShopActiveFeatures(shopId: string, entitlements: ShopEntitlement[]): Promise<void>;
